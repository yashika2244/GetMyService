...
// //             onClick={() => navigate("/chat", { state: { name, photo } })}
// //           />
...
// //           <h2 className="pt-3 pl-2 text-slate-800 font-medium">
// //             {" "}
...
// //                         onClick={() =>
// //                           navigate(`/Service-profile/${profile.id}`, {
// //                             state: profile, // Passing the correct profile data
// //                           })
// //                         }
// //                       >
// //                         {profile.name}
      ...
      <div className="hidden  md:flex flex-col ml-6   ">
        ...
        <div className=" mt-2  h-[calc(100vh-5px)] border border-gray-300 rounded-xl bg-white   w-[300px]   overflow-y-auto">
          ...
          {Array.isArray(accounts) && accounts.length > 0 ? (
            ...
            <div>No other profiles found</div>
          )}
        </div>
      </div>
    </section>
